...
import 'package:simpleweatherapp/bloc/weather_bloc.dart';
...
class _WeatherDetailPageState extends State<WeatherDetailPage> {
  ...
  Widget build(BuildContext context) {
    // dont put blocprovider because you dont want to initiate getting data everytime weather is rebuilt
    // use a stateful widget and put it in the didChangeDependencies instead
